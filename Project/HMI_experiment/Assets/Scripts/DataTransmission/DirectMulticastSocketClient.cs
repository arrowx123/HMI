...
//		private static string _multicastIPAddress = "224.0.0.1";
		...
		private static void StartClient() 
		{
			...
			try
			{
				...
				Debug.Log("DirectMulticastSocketClient -> OptitrackManagement: [UDP] Starting client");
...
//				IPAddress ip=IPAddress.Parse(_multicastIPAddress);
				...
				// Test
				Debug.Log("DirectMulticastSocketClient -> OptitrackManagement: IP address:" + IPAddress.Any);

				
			} catch (Exception e) 
			{
				Debug.LogError("DirectMulticastSocketClient -> OptitrackManagement: [UDP] DirectMulticastSocketClient: " + e.ToString());
			}
		}
		...
		private static bool Receive(Socket client) 
		{
			try 
			{
				...
				Debug.Log("DirectMulticastSocketClient -> OptitrackManagement: [UDP multicast] Receive");
